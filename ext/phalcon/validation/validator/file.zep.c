...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_6) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_12, 435, _9, field, _11);
	...
	if (!(_16)) {
		...
		ZEPHIR_CALL_FUNCTION(&_9, "is_uploaded_file", NULL, 226, _17);
		zephir_check_call_status();
	...
	if (_16) {
		...
		ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 435, _18, field, _19);
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 435, _9, field, _19);
		zephir_check_temp_parameter(_19);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, _11);
		zephir_check_call_status();
	...
	if (zephir_is_true(_9)) {
		...
		ZEPHIR_CALL_FUNCTION(&_18, "floatval", &_25, 298, _24);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_26);
		...
		ZEPHIR_CALL_FUNCTION(&_18, "floatval", &_25, 298, _29);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_30, "floatval", &_25, 298, bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(_18, _30)) {
			...
			ZEPHIR_CALL_METHOD(NULL, _26, "__construct", &_12, 435, _31, field, _32);
	...
	if (_33) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 234, _24);
		zephir_check_call_status();
		...
		if (_34) {
			...
			ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 435, _31, field, _19);
			zephir_check_temp_parameter(_19);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, _11);
			zephir_check_call_status();
		...
		if (zephir_is_true(_31)) {
			...
			if (_36) {
				...
				ZEPHIR_CALL_METHOD(NULL, _19, "__construct", &_12, 435, _37, field, _22);
