...
PHP_METHOD(Phalcon_Validation_Validator_Email, validate) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 274);
	ZEPHIR_CALL_FUNCTION(&_1, "filter_var", NULL, 185, value, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(_1))) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			ZEPHIR_INIT_NVAR(_2);
			ZVAL_STRING(_2, "Email", ZEPHIR_TEMP_PARAM_COPY);
		...
		ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, 435, _3, field, _4);
