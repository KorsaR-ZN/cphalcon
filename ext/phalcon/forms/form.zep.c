...
PHP_METHOD(Phalcon_Forms_Form, bind) {
	...
	ZVAL_NULL(filter);
	zephir_is_iterable(data, &_1, &_0, 0, 0, "phalcon/forms/form.zep", 256);
	for (
...
PHP_METHOD(Phalcon_Forms_Form, isValid) {
	...
	array_init(messages);
	zephir_is_iterable(elements, &_4, &_3, 0, 0, "phalcon/forms/form.zep", 371);
	for (
		...
		if (Z_TYPE_P(validators) == IS_ARRAY) {
			if (zephir_fast_count_int(validators TSRMLS_CC)) {
				...
				if (Z_TYPE_P(validation) == IS_OBJECT) {
					...
					ZEPHIR_CALL_METHOD(NULL, validation, "__construct", &_11, 204, preparedValidators);
					zephir_check_call_status();
				}
				ZEPHIR_CALL_METHOD(&filters, element, "getfilters", NULL, 0);
				zephir_check_call_status();
				if (Z_TYPE_P(filters) == IS_ARRAY) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, validation, "setfilters", &_12, 205, _2, filters);
					zephir_check_call_status();
				}
				ZEPHIR_CALL_METHOD(&elementMessages, validation, "validate", &_13, 206, data, entity);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(messages) == IS_ARRAY) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_2, &_1)
			...
			ZEPHIR_CALL_METHOD(NULL, group, "appendmessages", &_4, 207, elementMessages);
			zephir_check_call_status();
		}
	}
	RETURN_CCTOR(group);
...
PHP_METHOD(Phalcon_Forms_Form, get) {
	...
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 9, _2);
	zephir_check_call_status();
	zephir_throw_exception_debug(_1, "phalcon/forms/form.zep", 531 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Forms_Form, label) {
	...
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 9, _2);
	zephir_check_call_status();
	zephir_throw_exception_debug(_1, "phalcon/forms/form.zep", 545 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Forms_Form, rewind) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_elements"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_values", NULL, 208, _0);
	zephir_check_call_status();
