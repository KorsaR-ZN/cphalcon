...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasOne) {
	...
	ZEPHIR_INIT_VAR(_1);
	ZVAL_LONG(_1, 1);
	ZEPHIR_CALL_METHOD(NULL, relation, "__construct", NULL, 304, _1, referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasMany) {
	...
	ZEPHIR_INIT_VAR(_0);
	ZVAL_LONG(_0, 2);
	ZEPHIR_CALL_METHOD(NULL, relation, "__construct", NULL, 304, _0, referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(alias);
	if (zephir_array_isset_string_fetch(&alias, options, SS("alias"), 0 TSRMLS_CC)) {
		if (Z_TYPE_P(alias) != IS_STRING) {
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasManyToMany) {
	...
	ZEPHIR_CALL_METHOD(NULL, relation, "__construct", NULL, 304, _0, referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, relation, "setintermediaterelation", NULL, 305, intermediateFields, intermediateModel, intermediateReferencedFields);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(alias);
	if (zephir_array_isset_string_fetch(&alias, options, SS("alias"), 0 TSRMLS_CC)) {
		if (Z_TYPE_P(alias) != IS_STRING) {
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, _mergeFindParameters) {
	...
	HashPosition _2, _7;
	zend_bool _0, _5, _10;
	zval *findParamsOne, *findParamsTwo, *key = NULL, *value = NULL, *findParams = NULL, *_1 = NULL, **_4, *_6, **_9, *_11 = NULL;
	...
	if (_0) {
		...
		ZEPHIR_INIT_VAR(_1);
		ZEPHIR_CONCAT_SVSV(_1, "(", findParamsOne, ") AND ", findParamsTwo);
	...
	if (Z_TYPE_P(findParamsOne) == IS_ARRAY) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_3, &_2)
			...
			_5 = ZEPHIR_IS_LONG_IDENTICAL(key, 0);
			if (!(_5)) {
				_5 = ZEPHIR_IS_STRING_IDENTICAL(key, "conditions");
			}
			if (_5) {
				if (!(zephir_array_isset_long(findParams, 0))) {
					zephir_array_update_long(&findParams, 0, &value, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1130);
				} else {
					...
					zephir_array_update_long(&findParams, 0, &_1, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1132);
				}
				continue;
			}
	...
	if (Z_TYPE_P(findParamsTwo) == IS_ARRAY) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_8, &_7)
			...
			if (_5) {
				if (!(zephir_array_isset_long(findParams, 0))) {
					zephir_array_update_long(&findParams, 0, &value, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1151);
				} else {
					zephir_array_fetch_long(&_6, findParams, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/manager.zep", 1153 TSRMLS_CC);
					ZEPHIR_INIT_LNVAR(_1);
					ZEPHIR_CONCAT_SVSV(_1, "(", _6, ") AND ", value);
					zephir_array_update_long(&findParams, 0, &_1, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1153);
				}
				continue;
			}
			_10 = ZEPHIR_IS_STRING_IDENTICAL(key, "bind");
			if (!(_10)) {
				_10 = ZEPHIR_IS_STRING_IDENTICAL(key, "bindTypes");
			}
			if (_10) {
		...
		if (Z_TYPE_P(findParamsTwo) == IS_STRING) {
			if (!(zephir_array_isset_long(findParams, 0))) {
				zephir_array_update_long(&findParams, 0, &findParamsTwo, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1176);
			} else {
				...
				zephir_array_update_long(&findParams, 0, &_1, PH_COPY | PH_SEPARATE, "phalcon/mvc/model/manager.zep", 1178);
			}
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationRecords) {
	...
	if (zephir_is_true(_0)) {
		...
		if (Z_TYPE_P(fields) != IS_ARRAY) {
			...
			zephir_check_call_status();
			zephir_array_update_string(&placeholders, SL("APR0"), &_2, PH_COPY | PH_SEPARATE);
		} else {
		...
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "_mergefindparameters", &_3, 306, extraParameters, parameters);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_4);
		zephir_fast_join_str(_4, SL(" AND "), joinConditions TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, builder, "innerjoin", NULL, 0, intermediateModel, _4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_5);
		zephir_fast_join_str(_5, SL(" AND "), conditions TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, builder, "andwhere", NULL, 0, _5, placeholders);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_6, builder, "getquery", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(_6, "execute", NULL, 0);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	zephir_check_call_status();
	if (Z_TYPE_P(fields) != IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_6, relation, "getreferencedfields", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_INIT_LNVAR(_1);
		...
		zephir_check_call_status();
		zephir_array_update_string(&placeholders, SL("APR0"), &_7, PH_COPY | PH_SEPARATE);
	} else {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_9, &_8)
			...
			ZEPHIR_CONCAT_SV(_14, "APR", refPosition);
			zephir_array_update_zval(&placeholders, _14, &_7, PH_COPY | PH_SEPARATE);
		}
	}
	ZEPHIR_INIT_VAR(findParams);
	...
	zephir_array_fast_append(findParams, _4);
	...
	ZEPHIR_CALL_METHOD(&findArguments, this_ptr, "_mergefindparameters", &_3, 306, findParams, parameters);
	zephir_check_call_status();
	if (Z_TYPE_P(extraParameters) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&findParams, this_ptr, "_mergefindparameters", &_3, 306, findArguments, extraParameters);
		zephir_check_call_status();
	} else {
		ZEPHIR_CPY_WRT(findParams, findArguments);
	}
	if (ZEPHIR_IS_STRING_IDENTICAL(method, "")) {
		ZEPHIR_CALL_METHOD(&_2, relation, "gettype", NULL, 0);
		zephir_check_call_status();
		do {
	...
	ZEPHIR_CALL_METHOD(&_2, relation, "isreusable", NULL, 0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "load", NULL, 0, referencedModel);
	zephir_check_call_status();
	zephir_array_fast_append(_16, _2);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, __destruct) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, phalcon_mvc_model_query_ce, "clean", &_0, 307);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
