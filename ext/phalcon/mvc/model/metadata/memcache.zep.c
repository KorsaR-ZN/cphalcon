...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 308, _2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 311, _1, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, reset) {
	...
	if (Z_TYPE_P(meta) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(_0);
		zephir_is_iterable(meta, &_2, &_1, 0, 0, "phalcon/mvc/model/metadata/memcache.zep", 131);
		for (
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_memcache_ce, this_ptr, "reset", &_5, 310);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
