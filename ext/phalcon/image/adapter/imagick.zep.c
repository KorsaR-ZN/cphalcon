...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 222, &_2);
	zephir_check_call_status();
	if (zephir_is_true(_3)) {
		ZEPHIR_SINIT_NVAR(_2);
		ZVAL_STRING(&_2, "Imagick::IMAGICK_EXTNUM", 0);
		ZEPHIR_CALL_FUNCTION(&_4, "constant", NULL, 184, &_2);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct) {
	...
	if ((zephir_file_exists(_2 TSRMLS_CC) == SUCCESS)) {
		...
		if (!(zephir_is_true(_11))) {
			...
			ZEPHIR_CALL_FUNCTION(&_14, "constant", NULL, 184, &_13);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_12, "constant", &_15, 184, &_14);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, 0);
		ZEPHIR_INIT_NVAR(_6);
		...
		ZEPHIR_CALL_FUNCTION(&_17, "constant", &_15, 184, &_14);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_14);
		ZVAL_STRING(&_14, "Imagick::CHANNEL_ALPHA", 0);
		ZEPHIR_CALL_FUNCTION(&_18, "constant", &_15, 184, &_14);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_3);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_9, "constant", &_15, 184, &_14);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "constant", &_15, 184, &_14);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_5, "constant", &_6, 184, &_4);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_1);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _text) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 181, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_4);
	...
	if (Z_TYPE_P(offsetX) == IS_BOOL) {
		if (Z_TYPE_P(offsetY) == IS_BOOL) {
			...
			if (_6) {
				...
				ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_7, 184, &_0);
				zephir_check_call_status();
			} else {
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6, "constant", &_7, 184, &_5);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_2);
		ZVAL_LONG(_2, 0);
		ZEPHIR_INIT_NVAR(_8);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	while (1) {
		...
		if (!(zephir_is_true(_9))) {
			...
			ZEPHIR_CALL_FUNCTION(&_11, "constant", &_12, 184, &_0);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15, "constant", &_12, 184, &_0);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_4);
		...
		ZEPHIR_CALL_FUNCTION(&_21, "constant", &_12, 184, &_0);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_4);
		ZVAL_LONG(_4, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	if (ZEPHIR_IS_LONG(_8, 0)) {
		...
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "w", 0);
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 278, file, &_0);
		zephir_check_call_status();
		...
		if (_13) {
			...
			ZEPHIR_CALL_FUNCTION(&_15, "constant", NULL, 184, &_0);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(_4, 0)) {
		...
		if (_7) {
			...
			ZEPHIR_CALL_FUNCTION(&_9, "constant", NULL, 184, &_3);
			zephir_check_call_status();
