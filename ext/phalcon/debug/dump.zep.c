...
PHP_METHOD(Phalcon_Debug_Dump, all) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "func_get_args", NULL, 160);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "strtr", &_6, 54, &_5, _1);
		zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_8, &_7)
			...
			ZEPHIR_CALL_FUNCTION(&_13, "strtr", &_6, 54, &_5, _12);
			zephir_check_call_status();
			...
			if (_17) {
				...
				ZEPHIR_SINIT_NVAR(_5);
				ZVAL_LONG(&_5, (tab + 1));
				ZEPHIR_CALL_METHOD(&_18, this_ptr, "output", &_19, 161, value, _3, &_5);
				zephir_check_temp_parameter(_3);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_concat_self(&output, _2 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_13, "get_parent_class", &_21, 162, variable);
		zephir_check_call_status();
		...
		if (!(zephir_is_true(_22))) {
			ZEPHIR_CALL_FUNCTION(&_10, "get_object_vars", NULL, 24, variable);
			zephir_check_call_status();
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_24, &_23)
				...
				ZEPHIR_CALL_FUNCTION(&_26, "strtr", &_6, 54, &_5, _12);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_14);
				...
				ZEPHIR_SINIT_NVAR(_5);
				ZVAL_LONG(&_5, (tab + 1));
				ZEPHIR_CALL_METHOD(&_27, this_ptr, "output", &_19, 161, value, _3, &_5);
				zephir_check_temp_parameter(_3);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_20);
			...
			do {
				...
				ZEPHIR_CALL_FUNCTION(&attr, "each", &_28, 163, variable);
				...
				ZEPHIR_CALL_FUNCTION(&_10, "ord", &_29, 131, &_5);
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_13, "chr", &_30, 129, _10);
				zephir_check_call_status();
				...
				zephir_array_update_string(&_12, SL(":style"), &_26, PH_COPY | PH_SEPARATE);
				Z_SET_ISREF_P(key);
				ZEPHIR_CALL_FUNCTION(&_26, "end", &_32, 164, key);
				Z_UNSET_ISREF_P(key);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&attr, "get_class_methods", NULL, 165, variable);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_5);
		ZVAL_LONG(&_5, tab);
		ZEPHIR_CALL_FUNCTION(&_10, "str_repeat", &_11, 130, space, &_5);
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_35, &_34)
				...
				if (ZEPHIR_IS_STRING(value, "__construct")) {
					...
					ZEPHIR_SINIT_NVAR(_5);
					ZVAL_LONG(&_5, (tab + 1));
					ZEPHIR_CALL_FUNCTION(&_26, "str_repeat", &_11, 130, space, &_5);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_27, "strtr", &_6, 54, &_5, _38);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_2, "is_float", NULL, 166, variable);
	zephir_check_call_status();
	if (zephir_is_true(_2)) {
		...
		ZEPHIR_CALL_FUNCTION(&_13, "strtr", &_6, 54, &_5, _1);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "htmlentities", NULL, 146, variable, &_5, &_40);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_26, "nl2br", NULL, 167, _2);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_26, "strtr", &_6, 54, &_5, _1);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, variable) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 54, &_3, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Debug_Dump, variables) {
	...
	ZEPHIR_INIT_VAR(output);
	ZVAL_STRING(output, "", 1);
	ZEPHIR_CALL_FUNCTION(&_0, "func_get_args", NULL, 160);
	zephir_check_call_status();
