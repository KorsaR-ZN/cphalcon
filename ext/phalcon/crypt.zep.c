...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	if (Z_TYPE_P(iv) != IS_STRING) {
		ZEPHIR_CALL_FUNCTION(&_1, "strval", NULL, 21, iv);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_1, "mcrypt_encrypt", NULL, 0, cipher, encryptKey, padded, mode, iv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, encryptBase64) {
	...
	if (safe == 1) {
		...
		ZEPHIR_SINIT_VAR(_5);
		ZVAL_STRING(&_5, "-_", 0);
		ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 54, _2, &_4, &_5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "encrypt", &_1, 0, text, key);
...
PHP_METHOD(Phalcon_Crypt, decryptBase64) {
	...
	if (safe == 1) {
		...
		ZEPHIR_SINIT_VAR(_1);
		ZVAL_STRING(&_1, "+/", 0);
		ZEPHIR_CALL_FUNCTION(&_2, "strtr", NULL, 54, text, &_0, &_1);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getAvailableCiphers) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mcrypt_list_algorithms", NULL, 132);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, getAvailableModes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mcrypt_list_modes", NULL, 133);
	zephir_check_call_status();
	RETURN_MM();
