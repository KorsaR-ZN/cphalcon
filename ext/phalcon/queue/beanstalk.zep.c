...
PHP_METHOD(Phalcon_Queue_Beanstalk, connect) {
	...
	ZVAL_NULL(_3);
	Z_SET_ISREF_P(_2);
	ZEPHIR_CALL_FUNCTION(&connection, "fsockopen", NULL, 381, _0, _1, _2, _3);
	Z_UNSET_ISREF_P(_2);
	zephir_check_call_status();
	if (Z_TYPE_P(connection) != IS_RESOURCE) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, -1);
	ZEPHIR_CALL_FUNCTION(NULL, "stream_set_timeout", NULL, 382, connection, &_4, ZEPHIR_GLOBAL(global_null));
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, put) {
	...
	ZEPHIR_CALL_FUNCTION(&serialized, "serialize", NULL, 71, data);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readstatus", NULL, 383);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, reserve) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 384, this_ptr, _1, _4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, stats) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 385);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, peekReady) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 384, this_ptr, _2, _5);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, readYaml) {
	...
	if (zephir_fast_count_int(response TSRMLS_CC) > 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&data, "yaml_parse", NULL, 386, response);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Queue_Beanstalk, read) {
	...
	if (length) {
		...
		ZEPHIR_CALL_FUNCTION(&data, "fread", NULL, 387, connection, &_0);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1, "stream_get_meta_data", NULL, 388, connection);
		zephir_check_call_status();
		zephir_array_fetch_string(&_2, _1, SL("timed_out"), PH_NOISY | PH_READONLY, "phalcon/queue/beanstalk.zep", 354 TSRMLS_CC);
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_STRING(&_3, "\r\n", 0);
	ZEPHIR_RETURN_CALL_FUNCTION("stream_get_line", NULL, 389, connection, &_0, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, write) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("fwrite", NULL, 390, connection, packet, &_1);
	zephir_check_call_status();
	RETURN_MM();
